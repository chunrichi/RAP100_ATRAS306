CLASS zcl_rap100_gen_data_atras306 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_atras306 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 's306',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

    " 清除之前的数据
    DELETE FROM zrap100_atras306.


    " 查询示例数据
    INSERT zrap100_atras306  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table ZRAP100_ATRA{ group_id }. | ).
  ENDMETHOD.
ENDCLASS.
